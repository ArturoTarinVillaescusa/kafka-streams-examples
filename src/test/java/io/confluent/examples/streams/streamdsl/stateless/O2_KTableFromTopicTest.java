...
/**
 * Stream processing unit test of {@link O2_KTableFromTopic}, using TopologyTestDriver.
 *
 * See {@link O2_KTableFromTopic} for further documentation.
 */
public class O2_KTableFromTopicTest {
    ...
    public void setup() {
        ...
        O2_KTableFromTopic.createStream(builder);
        ...
        testDriver = new TopologyTestDriver(topology,
                O2_KTableFromTopic.getStreamsConfiguration("localhost:9092"));

        testInputTopic =
                testDriver.createInputTopic(O2_KTableFromTopic.inputTopic,
                                            stringSerializer, stringSerializer,
                                            Instant.ofEpochMilli(0),
                                            Duration.ofMillis(100));
        testOutputTopic =
                testDriver.createOutputTopic(O2_KTableFromTopic.outputTopic,
    ...
    public void outputTopicMustContainInputTopicRecords() {
        ...
        outputValues.put("key02","value02changed");
        outputValues.put("key03","value03");
