...
/**
 * Stream processing unit test of {@link O17_print}, using TopologyTestDriver.
 *
 * See {@link O17_print} for further documentation.
 */
public class O17_printTest {
    ...
    public void setup() {
        ...
        O17_print.createStream(builder);
        ...
        testDriver = new TopologyTestDriver(topology,
                               O17_print.getStreamsConfiguration("localhost:9092"));

        testInputTopic1 =
                testDriver.createInputTopic(O17_print.inputTopic1,
                        byteArraySerializer, stringSerializer);
        testInputTopic2 =
                testDriver.createInputTopic(O17_print.inputTopic2,
                        byteArraySerializer, stringSerializer);
        testOutputTopic =
                testDriver.createOutputTopic(O17_print.outputTopic,
