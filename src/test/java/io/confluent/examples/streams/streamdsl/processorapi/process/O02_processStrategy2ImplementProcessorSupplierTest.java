...
/**
 * Stream processing unit test of {@link O02_processStrategy2_ImplementProcessorSupplier}, using TopologyTestDriver.
 *
 * See {@link O02_processStrategy2_ImplementProcessorSupplier} for further documentation.
 */
public class O02_processStrategy2ImplementProcessorSupplierTest {
    ...
    public void setup() {
        ...
        O02_processStrategy2_ImplementProcessorSupplier.createStream(builder);
        ...
        testDriver = new TopologyTestDriver(topology,
                               O02_processStrategy2_ImplementProcessorSupplier.getStreamsConfiguration("localhost:9092"));

        testInputTopic =
                testDriver.createInputTopic(O02_processStrategy2_ImplementProcessorSupplier.inputTopic,
                                            stringSerializer, stringSerializer);
        testCountTableOutputTopic =
                testDriver.createOutputTopic(O02_processStrategy2_ImplementProcessorSupplier.outputTopic,
