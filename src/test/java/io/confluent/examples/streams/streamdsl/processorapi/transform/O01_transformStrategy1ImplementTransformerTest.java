...
/**
 * Stream processing unit test of {@link O01_transformStrategy1_ImplementTransformer}, using TopologyTestDriver.
 *
 * See {@link O01_transformStrategy1_ImplementTransformer} for further documentation.
 */
public class O01_transformStrategy1ImplementTransformerTest {
    ...
    public void setup() {
        ...
        O01_transformStrategy1_ImplementTransformer.createStream(builder);
        ...
        testDriver = new TopologyTestDriver(topology,
                               O01_transformStrategy1_ImplementTransformer.getStreamsConfiguration("localhost:9092"));

        testInputTopic =
                testDriver.createInputTopic(O01_transformStrategy1_ImplementTransformer.inputTopic,
                                            stringSerializer, stringSerializer);
        testCountTableOutputTopic =
                testDriver.createOutputTopic(O01_transformStrategy1_ImplementTransformer.outputTopic,
