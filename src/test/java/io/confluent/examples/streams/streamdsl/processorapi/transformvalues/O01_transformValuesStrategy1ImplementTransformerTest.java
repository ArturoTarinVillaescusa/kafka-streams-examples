...
/**
 * Stream processing unit test of {@link O01_transformValuesStrategy1_ImplementTransformer}, using TopologyTestDriver.
 *
 * See {@link O01_transformValuesStrategy1_ImplementTransformer} for further documentation.
 */
public class O01_transformValuesStrategy1ImplementTransformerTest {
    ...
    public void setup() {
        ...
        O01_transformValuesStrategy1_ImplementTransformer.createStream(builder);
        ...
        testDriver = new TopologyTestDriver(topology,
                               O01_transformValuesStrategy1_ImplementTransformer.getStreamsConfiguration("localhost:9092"));

        testInputTopic =
                testDriver.createInputTopic(O01_transformValuesStrategy1_ImplementTransformer.inputTopic,
                                            stringSerializer, stringSerializer);
        testCountTableOutputTopic =
                testDriver.createOutputTopic(O01_transformValuesStrategy1_ImplementTransformer.outputTopic,
