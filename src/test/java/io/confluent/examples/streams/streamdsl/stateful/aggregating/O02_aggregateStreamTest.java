...
/**
 * Stream processing unit test of {@link O02_aggregateStream}, using TopologyTestDriver.
 *
 * See {@link O02_aggregateStream} for further documentation.
 */
public class O02_aggregateStreamTest {
    ...
    public void setup() {
        ...
        O02_aggregateStream.createStream(builder);
        ...
        testDriver = new TopologyTestDriver(topology,
                               O02_aggregateStream.getStreamsConfiguration("localhost:9092"));

        testInputTopic =
                testDriver.createInputTopic(O02_aggregateStream.inputTopic,
                                            stringSerializer, intSerializer);
        testAggStreamOutputTopic =
                testDriver.createOutputTopic(O02_aggregateStream.aggStreamOutputTopic,
