...
/**
 * Stream processing unit test of {@link O05_countStream}, using TopologyTestDriver.
 *
 * See {@link O05_countStream} for further documentation.
 */
public class O05_countStreamTest {
    ...
    public void setup() {
        ...
        O05_countStream.createStream(builder);
        ...
        testDriver = new TopologyTestDriver(topology,
                               O05_countStream.getStreamsConfiguration("localhost:9092"));

        testInputTopic =
                testDriver.createInputTopic(O05_countStream.inputTopic,
                                            stringSerializer, intSerializer);
        testCountStreamOutputTopic =
                testDriver.createOutputTopic(O05_countStream.countStreamOutputTopic,
    ...
    public void outputTopicMustContainInputTopicRecords() {
        ...
        assertThat(testCountStreamOutputTopic.readKeyValuesToMap(), equalTo(outputValues));
        //No more output in topic
        assertTrue(testCountStreamOutputTopic.isEmpty());
    }
