...
/**
 * Stream processing unit test of {@link O10_groupByKey}, using TopologyTestDriver.
 *
 * See {@link O10_groupByKey} for further documentation.
 */
public class O10_groupByKeyTest {
    private TopologyTestDriver testDriver;
    private TestInputTopic<String, Long> testInputTopic;
    private TestOutputTopic<String, Long> testOutputTopic;
    private TestOutputTopic<String, Long> testOutputTopicDifferentValueType;
    ...
    public void setup() {
        ...
        O10_groupByKey.createStream(builder);
        ...
        testDriver = new TopologyTestDriver(topology,
                               O10_groupByKey.getStreamsConfiguration("localhost:9092"));

        testInputTopic =
                testDriver.createInputTopic(O10_groupByKey.inputTopic,
                        stringSerializer, integerSerializer);
        testOutputTopic =
                testDriver.createOutputTopic(O10_groupByKey.outputTopic,
                        stringDeserializer, longDeserializer);
        testOutputTopicDifferentValueType =
                testDriver.createOutputTopic(O10_groupByKey.outputTopicDifferentValueType,
                        stringDeserializer, longDeserializer);
    }
    ...
    public void outputTopicMustContainInputTopicRecords() {
        List<KeyValue<String, Long>> inputValues =
                Arrays.asList(  new KeyValue<>("1", 10L),
                                new KeyValue<>("1", 11L),
                                new KeyValue<>("2", 211L),
                                new KeyValue<>("2", 121L),
                                new KeyValue<>("2", 1L)
        ...
        outputValues.put("1", 2L);
        outputValues.put("2", 3L);
        ...
        assertThat(testOutputTopicDifferentValueType.readKeyValuesToMap(), equalTo(outputValues));
        //No more output in topic
        assertTrue(testOutputTopicDifferentValueType.isEmpty());
