...
/**
 * Stream processing unit test of {@link O02_transformValuesStrategy2_ImplementTransformerSupplier}, using TopologyTestDriver.
 *
 * See {@link O02_transformValuesStrategy2_ImplementTransformerSupplier} for further documentation.
 */
public class O02_transformValuesStrategy2ImplementTransformerSupplierTest {
    ...
    public void setup() {
        ...
        O02_transformValuesStrategy2_ImplementTransformerSupplier.createStream(builder);
        ...
        testDriver = new TopologyTestDriver(topology,
                               O02_transformValuesStrategy2_ImplementTransformerSupplier.getStreamsConfiguration("localhost:9092"));

        testInputTopic =
                testDriver.createInputTopic(O02_transformValuesStrategy2_ImplementTransformerSupplier.inputTopic,
                                            stringSerializer, stringSerializer);
        testCountTableOutputTopic =
                testDriver.createOutputTopic(O02_transformValuesStrategy2_ImplementTransformerSupplier.outputTopic,
