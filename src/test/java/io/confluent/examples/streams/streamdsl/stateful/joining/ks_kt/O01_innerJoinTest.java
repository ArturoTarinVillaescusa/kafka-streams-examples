...
public class O01_innerJoinTest {
    ...
    public void setup() {
        ...
        testLeftInputStreamTopic = topologyTestDriver
                .createInputTopic(O01_innerJoin.leftInputStreamTopic,
                        new StringSerializer(),
                        new StringSerializer());
        testRightInputTableTopic = topologyTestDriver
                .createInputTopic(O01_innerJoin.rightInputTableTopic,
                        new StringSerializer(),
                        new StringSerializer());
        testInnerJoinOutputTopic = topologyTestDriver
                .createOutputTopic(O01_innerJoin.innerJoinOutputTopic,
