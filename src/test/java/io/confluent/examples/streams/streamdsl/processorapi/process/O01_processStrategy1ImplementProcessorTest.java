...
/**
 * Stream processing unit test of {@link O01_processStrategy1_ImplementProcessor}, using TopologyTestDriver.
 *
 * See {@link O01_processStrategy1_ImplementProcessor} for further documentation.
 */
public class O01_processStrategy1ImplementProcessorTest {
    ...
    public void setup() {
        ...
        O01_processStrategy1_ImplementProcessor.createStream(builder);
        ...
        testDriver = new TopologyTestDriver(topology,
                               O01_processStrategy1_ImplementProcessor.getStreamsConfiguration("localhost:9092"));

        testInputTopic =
                testDriver.createInputTopic(O01_processStrategy1_ImplementProcessor.inputTopic,
                                            stringSerializer, stringSerializer);
        testCountTableOutputTopic =
                testDriver.createOutputTopic(O01_processStrategy1_ImplementProcessor.outputTopic,
