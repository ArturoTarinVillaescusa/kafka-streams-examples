...
/**
 * Stream processing unit test of {@link O02_hoppingTimeWindow}, using TopologyTestDriver.
 *
 * See {@link O02_hoppingTimeWindow} for further documentation.
 */
public class O02_hoppingTimeWindowTest {
    ...
    public void setup() {
        ...
        O02_hoppingTimeWindow.createStream(builder);
        ...
        testDriver = new TopologyTestDriver(topology,
                               O02_hoppingTimeWindow.getStreamsConfiguration("localhost:9092"));

        testInputTopic =
                testDriver.createInputTopic(O02_hoppingTimeWindow.inputTopic,
                                            stringSerializer, avroSerde.serializer());
        testCountTableOutputTopic =
                testDriver.createOutputTopic(O02_hoppingTimeWindow.countTableOutputTopic,
    ...
    public void shouldCountDifferentRecordKeysSeparatelyInSeparateWindowBlocks() throws IOException, RestClientException {
        ...
        expectedOutputMappedValues.put("timestamp: 2020-03-30T00:03:10Z, count: 1", "site1");
        expectedOutputMappedValues.put("timestamp: 2020-03-30T00:05:01Z, count: 2", "site1");
        expectedOutputMappedValues.put("timestamp: 2020-03-30T00:06:30Z, count: 3", "site1");

        // hop 3, key "site1"
        expectedOutputMappedValues.put("timestamp: 2020-03-30T00:00:20Z, count: 1", "site1");
        expectedOutputMappedValues.put("timestamp: 2020-03-30T00:06:30Z, count: 1", "site1");
        ...
        expectedOutputMappedValues.put("timestamp: 2020-03-30T00:05:50Z, count: 3", "site2");
