...
/**
 * Stream processing unit test of {@link O02_transformStrategy2_ImplementTransformerSupplier}, using TopologyTestDriver.
 *
 * See {@link O02_transformStrategy2_ImplementTransformerSupplier} for further documentation.
 */
public class O02_transformStrategy2ImplementTransformerSupplierTest {

    private TopologyTestDriver testDriver;
    private TestInputTopic<String, String> testInputTopic;
    private TestOutputTopic<Integer, String> testCountTableOutputTopic;
    ...
    public void setup() {
        ...
        O02_transformStrategy2_ImplementTransformerSupplier.createStream(builder);
        ...
        testDriver = new TopologyTestDriver(topology,
                               O02_transformStrategy2_ImplementTransformerSupplier.getStreamsConfiguration("localhost:9092"));

        testInputTopic =
                testDriver.createInputTopic(O02_transformStrategy2_ImplementTransformerSupplier.inputTopic,
                                            stringSerializer, stringSerializer);
        testCountTableOutputTopic =
                testDriver.createOutputTopic(O02_transformStrategy2_ImplementTransformerSupplier.outputTopic,
                        intDeserializer, stringDeserializer);
    }
    ...
    public void shouldCountDifferentRecordKeysSeparatelyInSeparateWindowBlocks() throws IOException, RestClientException {
        ...
        List<KeyValue<Integer, String>> expectedOutputMappedValues = Arrays.asList(
                new KeyValue<>(109447626, "ASDASDF")
        );
