...
import io.confluent.examples.streams.streamdsl.stateless.O5_filter;
...
/**
 * Stream processing unit test of {@link O5_filter}, using TopologyTestDriver.
 *
 * See {@link O5_filter} for further documentation.
 */
public class O5_filterTest {
    ...
    public void setup() {
        ...
        O5_filter.createStream(builder);
        ...
        testDriver = new TopologyTestDriver(topology,
                               O5_filter.getStreamsConfiguration("localhost:9092"));

        testInputTopic =
                testDriver.createInputTopic(O5_filter.inputTopic,
                                            stringSerializer, longSerializer);
        testOutputTopic =
                testDriver.createOutputTopic(O5_filter.outputTopic,
