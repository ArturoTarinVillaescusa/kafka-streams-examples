...
public class StreamToStreamJoinIntegrationTest {
  ...
  public void shouldJoinTwoStreams() {
    ...
    alerts.print(Printed.toFile("/tmp/ALERTS_STREAM.TXT"));
    incidents.print(Printed.toFile("/tmp/INCIDENTS_STREAM.TXT"));
    ...
    impressionsAndClicks.print(Printed.toFile("/tmp/impressionsandclicks.txt"));
