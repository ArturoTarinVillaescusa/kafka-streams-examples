...
public class StreamToTableJoinIntegrationTest {
  ...
  private static final String userClicksTopic = "user-clicks-topic";
  private static final String userRegionsTopic = "user-regions-topic";
  private static final String outputTopic = "clicks-per-region-topic";
  ...
  public void shouldCountClicksPerRegion() {
    ...
    userClicksStream.print(Printed.toFile("/tmp/userClicksStream.txt"));
    ...
    userRegionsTable.toStream().print(Printed.toFile("/tmp/userRegionsTable.txt"));
    ...
    final KTable<String, Long> clicksPerRegion = userClicksStream
      ...
      .reduce(Long::sum, Materialized.as("clicksPerRegion"));

    clicksPerRegion.toStream().print(Printed.toFile("/tmp/clicksPerRegion.txt"));
