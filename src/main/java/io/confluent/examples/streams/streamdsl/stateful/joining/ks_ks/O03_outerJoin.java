...
/**
 * Demonstrating the KStream DSL `outerJoin` method applied to a KStream-KStream pair
 **/

public class O03_outerJoin {
    static final String inputTopic1 = "input-stream-1";
    static final String inputTopic2 = "input-stream-2";
    static final String outerJoinOutputTopic = "innerjoin-stream-output";
    ...
    public static void createStream(StreamsBuilder streamsBuilder) {
        ...
        KStream<String, Long> left = streamsBuilder.stream(inputTopic1,
                Consumed.with(Serdes.String(), Serdes.Long()));

        // KStream from inputTopic2
        KStream<String, Double> right = streamsBuilder.stream(inputTopic2,
        ...
        right.print(Printed.toFile("/tmp/right.txt"));
        joined.print(Printed.toFile("/tmp/outerjoined.txt"));

        // Write the result to the output topic
        joined.to(outerJoinOutputTopic);
    ...
    public static Properties getStreamsConfiguration(String bootstrapServers) {
        ...
        properties.put(StreamsConfig.APPLICATION_ID_CONFIG, "outerjoin");
        properties.put(StreamsConfig.CLIENT_ID_CONFIG, "outerjoin-client");
