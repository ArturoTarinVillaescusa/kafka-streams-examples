...
import io.confluent.examples.streams.GlobalKTablesExampleDriver;
 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-6.0.0-standalone.jar io.confluent.examples.streams.GlobalKTablesExample
 * }
 * </pre>
 ...
 * # all EnrichedOrders
 * $ java -cp target/kafka-streams-examples-6.0.0-standalone.jar io.confluent.examples.streams.GlobalKTablesExampleDriver
 * }
 * </pre>
 * <p>
 ...
 */
public class O01_anyKindOfJoin {
  ...
  public static final String ENRICHED_ORDER_TOPIC = "enriched-order";
  ...
  public static KafkaStreams createStreams(final String bootstrapServers,
    ...
    ordersStream.print(Printed.toFile("/tmp/ordersStream.txt"));
    ...
    final KStream<Long, CustomerOrder> customerOrdersStream =
            // Also valid for ordersStream.leftJoin(....
            ordersStream.join(customersGlobalKTable,
                              (orderId, order) -> order.getCustomerId(),
                              (order, customer) -> new CustomerOrder(customer, order));

    customerOrdersStream.print(Printed.toFile("/tmp/customerOrdersStream.txt"));
    ...
    final KStream<Long, EnrichedOrder> enrichedOrdersStream =
        customerOrdersStream.join(productsGlobalKTable,
                                  // Key
    ...
    enrichedOrdersStream.print(Printed.toFile("/tmp/enrichedOrdersStream.txt"));
