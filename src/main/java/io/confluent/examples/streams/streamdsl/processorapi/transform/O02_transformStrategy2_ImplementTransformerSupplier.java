...
import io.confluent.examples.streams.streamdsl.processorapi.utils.transformers.EmailMetricThresholdAlert_TransformerSupplier;
 ...
 *
 *
 * 2) The second strategy (DEMOSTRATED IN THIS EXAMPLE) is for the given TransformerSupplier to implement ConnectedStoreProvider.stores(),
 *    which provides the StoreBuilders to be automatically added to the topology and connected to the
 *    transformer.
 **/

@Slf4j
public class O02_transformStrategy2_ImplementTransformerSupplier {
    ...
    public static void createStream(StreamsBuilder streamsBuilder) {
        ...
        KStream transformedStream =
                sourceStream
                .transform(new EmailMetricThresholdAlert_TransformerSupplier(),
                        Named.as("Transformation-Step"));
