...
/**
 * Demonstrating the KStream DSL `join` method applied to a KTable-KTable pair
 **/

public class O01_innerJoin {
    static final String inputTopic1 = "input-ktable-1";
    static final String inputTopic2 = "input-ktable-2";
    static final String innerJoinOutputTopic = "innerjoin-ktable-output";
    ...
    public static void createStream(StreamsBuilder builder) {
        ...
        // This foreingKeyExtractor simply uses the left-value to map the right-key
        Function<Integer, Integer> foreingKeyExtractor = (x) -> x;
        
        KTable<String, String> joined = left.join(
                right,                                          // Right stream
                foreingKeyExtractor,
        ...
        joined.toStream().print(Printed.toFile("/tmp/innerjoined.txt"));
    ...
    public static Properties getStreamsConfiguration(String bootstrapServers) {
        ...
        properties.put(StreamsConfig.APPLICATION_ID_CONFIG, "ktables-join");
        properties.put(StreamsConfig.CLIENT_ID_CONFIG, "ktables-join-client");
