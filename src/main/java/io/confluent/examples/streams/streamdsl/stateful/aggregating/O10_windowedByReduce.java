...
/**
 * Demonstrating the KStream DSL `windowdBy` and `reduce` methods applied together
 *
 **/

public class O10_windowedByReduce {
    static final String inputTopic = "input";
    static final String timeWindowedReduceOutTopic = "time-windowed-reduce-output";
    static final String sessionWindowedReduceOutTopic = "sessionized-reduce-output";
    ...
    public static void createStream(StreamsBuilder streamsBuilder) {
        ...
        /**********************************************
         * Reducing a KGroupedStream with time-based windowing
         * with 5 minutes tumbling windows
         **********************************************/
        KTable<Windowed<String>, Long> timeWindowedReduceStream =
            groupedStream
...
//        timeWindowedReduceStream.toStream().print(Printed.toSysOut());

        // Write the timeWindowedAggregatedStream to the output topic
        timeWindowedReduceStream.toStream().to(timeWindowedReduceOutTopic);

        /**********************************************
         * Reducing a KGroupedStream with session-based windowing
         * with 5 minutes inactivity gaps
         **********************************************/
        KTable<Windowed<String>, Long> sessionWindowedReduceStream =
                groupedStream
...
//        sessionWindowedCountStream.toStream().print(Printed.toSysOut());
        ...
        // Write the timeWindowedAggregatedStream to the output topic
        sessionWindowedReduceStream.toStream().to(sessionWindowedReduceOutTopic);
