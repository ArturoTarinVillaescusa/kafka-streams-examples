...
public class O07_windowedByCount {
    static final String inputTopic = "input";
    static final String timeWindowedCountOutTopic = "time-windowed-count-output";
    static final String sessionWindowedCountOutTopic = "sessionized-count-output";
