...
/**
 * Demonstrating the KStream DSL `leftJoin` method applied to a KStream-KTable pair
 **/

public class O02_leftJoin {
    static final String leftInputStreamTopic = "input-stream-1";
    static final String rightInputTableTopic = "input-stream-2";
    static final String innerJoinOutputTopic = "leftjoin-stream-output";
    ...
    public static void createStream(StreamsBuilder streamsBuilder) {
        ...
        KStream<String, String> joined = left.leftJoin(
                ...
                Joined.keySerde(Serdes.String())      // key
                      .valueSerde(Serdes.String())    // left value
        );
        ...
        joined.to(innerJoinOutputTopic);
    ...
    public static Properties getStreamsConfiguration(String bootstrapServers) {
        ...
        properties.put(StreamsConfig.APPLICATION_ID_CONFIG, "leftjoin-ks-kt");
        properties.put(StreamsConfig.CLIENT_ID_CONFIG, "leftjoin-ks-kt-client");
